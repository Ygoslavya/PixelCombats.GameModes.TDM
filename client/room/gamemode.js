...
// Автоматическое распределение игроков по командам при входе нового игрока
Players.OnPlayerJoin.Add(function (player) {
    // Определяем команду с меньшим количеством игроков
    const blueTeamCount = blueTeam.Players.length;
    const redTeamCount = redTeam.Players.length;

    // Добавляем игрока в команду с меньшим количеством участников
