...
function SetGameMode() {
    ...
    for (const player of Players.All) {
        AssignPlayerToTeam(player); // Распределяем игрока в команду
...
// Функция для автоматического распределения игрока в команду
function AssignPlayerToTeam(player) {
    if (redTeam.Players.Count < blueTeam.Players.Count) {
        redTeam.AddPlayer(player);
        player.Properties.Team.Value = redTeam.Name; // Устанавливаем команду игрока
    } else {
        blueTeam.AddPlayer(player);
        player.Properties.Team.Value = blueTeam.Name; // Устанавливаем команду игрока
    }
}
...
function ResetGame() {
    ...
    for (const player of Players.All) {
        ...
        AssignPlayerToTeam(player); // Распределяем игрока в команду заново для нового раунда
